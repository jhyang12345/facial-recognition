...
def get_eyes_angle(landmark, image):
    ...
    print(landmark.keys())
    # draw_landmarks(left_center, right_center, nose_center, image)
...
def draw_landmarks(left_center, right_center, nose_center, image):
